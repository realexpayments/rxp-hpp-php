...
{
    private static $KNOWN_FIELDS = array('MERCHANT_ID', 'ACCOUNT', 'AMOUNT', 'AUTH_CODE', 'TIMESTAMP',
        'SHA1HASH', 'RESULT', 'MESSAGE', 'CVNRESULT', 'PASREF', 'BATCHID', 'ECI', 'CAVV', 'XID',
        'COMMENT1', 'COMMENT2', 'TSS');
